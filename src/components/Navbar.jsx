                ...
                <div className="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 px-5">
                            <li class="nav-item">
                                <NavLink className="nav-link text-light nav-link-text mx-3" aria-current="page" to="/">
                                    <span className='p-1'><img src="/images/home.png" alt="" /></span>
                                    Home
                                </NavLink>
                            </li>
                            <li class="nav-item">
                                <NavLink className="nav-link text-light  nav-link-text mx-3" aria-current="page" to="/about">
                                    <span className='p-1'><img src="/images/profile.png" alt="" /></span>
                                    About
                                </NavLink>
                            </li>
                            <li class="nav-item">
                                <NavLink className="nav-link text-light  nav-link-text mx-3" aria-current="page" to="/projects">
                                    <span className='p-1'><img src="/images/proj.png" alt="" /></span>
                                    Projects
                                </NavLink>
                            </li>
                            <li class="nav-item">
                                <NavLink className="nav-link text-light  nav-link-text mx-3" aria-current="page" to="/resume">
                                    <span className='p-1'><img src="/images/doc.png" alt="" /></span>
                                    Resume
                                </NavLink>
                            </li>
                            <li class="nav-item">
                                <NavLink className="nav-link text-light  nav-link-text mx-3" aria-current="page" to="/contact">
